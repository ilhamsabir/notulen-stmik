...
<div id="content">
  <div id="content-header">
    ...
    <i class="icon-home"></i> Dashboard</a> <a href="<?php echo base_url('admin/acara_internal') ?>"> List Data Acara Internal</a> <a href="#" class="current">Tambah Data Acara</a> </div>
  ...
  <hr>
    <div class="row-fluid">
      ...
      ?>
      <a href="<?php echo base_url('admin/acara_internal') ?>" class="btn btn-success">Kembali</a>
