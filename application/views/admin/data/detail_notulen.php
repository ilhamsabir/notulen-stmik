  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
      ...
      <div class="span6">
        ...
        <a href="<?php echo base_url('report/notulen_admin/'.$show->kode_acara) ?>" class="btn btn-danger btn-large" title="Download PDF"><i class="icon-file"></i></a>
        <div class="pull-right">
          <a href="<?php echo base_url('admin/send_notulen/'.$show->kode_acara) ?>" class="btn btn-warning btn-large" title="Kirim Notulen"><i class="icon-envelope"></i></a>
        </div>
      </div>
  </div>
</div>
