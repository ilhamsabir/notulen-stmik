...
<div id="content-header">
  <div id="breadcrumb"> 
    <a href="<?php echo base_url() ?>admin" title="Ke Dashboard" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="#" class="current">List Data Notulen</a> 
  </div>
...
<div class="container-fluid">
  ...
  <div class="row-fluid">
    ...
    ?>
  <a class="btn btn-primary" href="<?php echo base_url() ?>admin/acara_internal">
  Data Acara Internal</a> <a class="btn btn-primary" href="<?php echo base_url() ?>admin/acara_eksternal">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td>
                    ...
                    <a class="btn btn-success" href="<?php echo base_url('admin/update_notulen/'.$show->kode) ?>" title="Edit"><i class="icon-edit"></i></a> 
                    <?php } ?>
