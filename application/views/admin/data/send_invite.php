    ...
    <div class="row-fluid">
      ...
      <a href="#" onclick="history.go(-1)" class="btn btn-success">Kembali</a>
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <?php echo form_open_multipart(base_url('admin/send_invite/'.$show->kode), array('class' => 'form-horizontal')) ?>
      ...
      <a href="#" onclick="history.go(-1)" class="btn btn-success">Kembali</a>
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <?php echo form_open_multipart(base_url('admin/invite_eks/'.$show->kode), array('class' => 'form-horizontal')) ?>
            <input type="hidden" name="kode_acara" value="<?php echo $show->kode ?>">
            <div class="control-group">
                <label class="control-label">Pengaju Acara:</label>
                <div class="controls">
              ...
              <div class="control-group">
                <label class="control-label">Penerima Undangan:</label>
                <div class="controls">
