...
<div id="content">
  <div id="content-header">
    ...
    <i class="icon-home"></i> Dashboard</a> <a href="<?php echo base_url('admin/acara_internal') ?>"> List Data Acara Internal</a> <a href="#" class="current">Edit Data Acara</a> </div>
      ...
      <a href="#" onclick="history.go(-1)" class="btn btn-success">Kembali</a>
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <?php echo form_open(base_url('admin/update_acara/'.$show->kode), array('class' => 'form-horizontal')) ?>
