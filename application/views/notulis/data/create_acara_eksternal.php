...
<div id="content">
  <div id="content-header">
    ...
    <i class="icon-home"></i> Dashboard</a> <a href="<?php echo base_url('notulis/acara_eksternal') ?>"> List Data Acara Eksternal</a> <a href="#" class="current">Tambah Data Acara</a> </div>
  ...
  <hr>
    <div class="row-fluid">
      ...
      ?>
      <a href="<?php echo base_url('notulis/acara_eksternal') ?>" class="btn btn-success">Kembali</a>
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
            <h5>Form Tambah</h5>
          </div>
          <div class="widget-content nopadding">
            <?php echo form_open(base_url('notulis/create_acaraEks'), array('class' => 'form-horizontal')) ?>
