...
<div id="content-header">
  <div id="breadcrumb"> 
    <a href="<?php echo base_url() ?>notulis" title="Ke Dashboard" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="#" class="current">Laporan Eksternal</a> 
  </div>
...
<div class="container-fluid">
  ...
  <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <?php echo form_open(base_url('notulis/report_eksternal'), array('name' => 'periode', 'class' => 'form-horizontal')) ?>
