<div id="content">
  <div id="content-header">
    ...
    <i class="icon-home"></i> Dashboard</a> <a href="<?php echo base_url('notulis/list_notulen') ?>"> List Data Notulen</a> <a href="#" class="current">Edit Data Notulen</a> </div>
      ...
      <a href="#" onclick="history.go(-1)" class="btn btn-success">Kembali</a>
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <?php echo form_open_multipart(base_url('notulis/update_notulen/'.$show->kode), array('class' => 'form-horizontal')) ?>
              <div class="control-group">
                <input type="hidden" name="kode"  value="<?php echo $show->kode ?>">
              <div class="control-group">
                <label class="control-label">Isi Rapat:</label>
                <div class="controls">
                  <textarea name="isi" id="textarea" rows="15"><?php echo $show->isi ?></textarea>
                </div>
              </div>
